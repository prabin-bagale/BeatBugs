...
export function BeatDetailView() {
  const { selectedBeat, goBack, startCheckout, showToast, selectBeat, selectProducer } = useAppStore();
  const { playBeat, pauseBeat, currentlyPlaying, isPlaying, updateAudioTime } = useAudioStore();
